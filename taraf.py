...
class TarafEkle(QtWidgets.QDialog):
    ...
    def sahis_ekle(self):
        ...
        #Veritabanına Gönder
        if self.db.tarafekle(ad, sifat, tc, baba, ana, dyer, dtar, cins, tel, adresniteligi, adres, self.dosya_uzlasma_no) == True:
    ...
    def vekil_ekle(self):
        ...
        # Veritabanına Gönder
        if self.db.temsilci_ekle(ad, sicil, telefon, adres, self.dosya_uzlasma_no, vekalet, sifat) == True:
